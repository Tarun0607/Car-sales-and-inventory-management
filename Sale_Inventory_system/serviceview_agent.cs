...
{
    public partial class serviceview_agent : Form
    {
        public serviceview_agent()
        {
            InitializeComponent();
        }
        ...
        public void refresh_DataGridView()
        {
            try
            {
                SqlCommand cmd = new SqlCommand("Showspecificservice_sp", conn);
        ...
        private void serviceview_agent_Load(object sender, EventArgs e)
        {
